...
app.get("/getContactsByID/:id", function (req, res) {
  res.send(getContactsByID(req.params.id));
});
app.get("/getContactsByAlphabets/:alphabet", function (req, res) {
  res.send(getContactsByAlphabets(req.params.alphabet));
});
app.get("/deleteContactByName/:Name", function (req, res) {
  res.send(deleteContactByName(req.params.Name));
});

app.post("/updateContactByID/:userId", function (req, res) {
  res.send(updateContactByID(req.body, req.params.userId));
});

app.post("/createNewContact", function (req, res) {
